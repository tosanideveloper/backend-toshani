...
public class AppConstant {
    ...
    public static final String PAGE_NUMBER_PROPERTY_NAME = "pageNo";
    public static final String PAGE_SIZE_PROPERTY_NAME = "pageSize";
    public static final String SORT_BY_PROPERTY_NAME = "sortBy";
    public static final String ORDER_TYPE_PROPERTY_NAME = "orderType";
