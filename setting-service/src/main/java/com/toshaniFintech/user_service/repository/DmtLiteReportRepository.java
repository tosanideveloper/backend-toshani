...
@Repository
public interface DmtLiteReportRepository extends JpaRepository<DmtLiteReportEntity, String> {

    @Query("SELECT d FROM DmtLiteReportEntity d " +
    ...
    Page<DmtLiteReportEntity> fetchDmtLiteReport(
