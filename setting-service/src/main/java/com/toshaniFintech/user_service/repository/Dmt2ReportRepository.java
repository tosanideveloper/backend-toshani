...
@Repository
public interface Dmt2ReportRepository extends JpaRepository<Dmt2ReportEntity, String> {

    @Query("SELECT d FROM Dmt2ReportEntity d " +
    ...
    Page<Dmt2ReportEntity> fetchDmt2Report(
