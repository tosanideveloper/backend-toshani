...
@Repository
public interface DmtLite1ReportRepository extends JpaRepository<DmtLite1ReportEntity, String> {

    @Query("SELECT d FROM DmtLite1ReportEntity d " +
    ...
    Page<DmtLite1ReportEntity> fetchDmtLite1Report(
