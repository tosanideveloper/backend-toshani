...
@Repository
public interface AdminCreditWalletReportRepository extends JpaRepository<AdminCreditWalletReportEntity,String> {
    @Query("SELECT a FROM AdminCreditWalletReportEntity a " +
    ...
    Page<AdminCreditWalletReportEntity> fetchAdminCreditWalletReport(
