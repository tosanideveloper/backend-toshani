...
@Repository
public interface CreditWalletReportRepository extends JpaRepository<CreditWalletReportEntity, String> {
    @Query("SELECT a FROM CreditWalletReportEntity a " +
    ...
    Page<CreditWalletReportEntity> fetchCreditWalletReport(
